...
' 
' Description:   EVXTestsAI2W0060.vbs queues up testes on said machine
'
...
'************* declarations  *********************************************************//
file="D:\ShareThis\EVXCommand\AI2W0060TestTable.txt"
machine = "AI2W0060"	
	...
	Do While Not open.AtEndOfStream
	 ...
	 Else
	   ...
	   If str<>"" And str<>" " Then 
	     ...
	     action = "Evernix Test ID "&TestID&" on machine "&machineName& " was triggered with this command " & CS
         Stamp = Now
         LogToFileFunction RF,TestID,Stamp,action
	     fso.CopyFile CS,MachineTaskFolder,True
	   End If
	 End If 
	Loop
End If 				
