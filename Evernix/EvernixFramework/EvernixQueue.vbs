...
' 
' Description:   EvernixQueue.vbs queues up testes on said machine
'
...
'************* declarations  *********************************************************//
file="D:\ShareThis\EVXCommand\AI2W0047TestTable.txt"
machine = "AI2W0047"	
QueuePathFile = "D:\ShareThis\Win8queue.txt"
emailaddress = "ajomaa@aisquared.com"  																	
MachineTaskFolder = "\\ai2s-lab01\QALAB\ATS\ATM\atm_servers\" & machine & "\Tasks\"
InstallLocationFilePath = "\\ai2s-lab01\QALAB\ATS\ATM\atm_resources\InstallLocationEverest101.txt"																				
' ******************************************************************************************//
...
'  ****  setup installLocation10.txt file  ****
	...
	line = objQueueTextStream.ReadLine
	 ...
	 If fso.FolderExists(line) Then 
		...
		WScript.Sleep(60000)
		wshell.Run "D:\ShareThis\EvernixScripts\EVXTestsAI2WCYBER01.vbs "&line,4,False 				
		WScript.Sleep(120000)
		WScript.Sleep(120000)
		Process="EVXTestsAI2W-0013.vbs"
        ProcessKill Process
	    wshell.Run "D:\ShareThis\EvernixScripts\EVXTestsAI2W-0013.vbs "&line,4,False 
        WScript.Sleep(120000)
		'WScript.Sleep(120000)
		wshell.Run "D:\ShareThis\EvernixScripts\EVXTestsAI2W0047.vbs "&line,4,False
	    WScript.Sleep (120000)
	    ' Windows Eyes Tests
		'wshell.Run "D:\ShareThis\EvernixScripts\EVXTestsAI2W-0018.vbs "&line,4,False
		'WScript.Sleep(120000)
	    'WScript.Sleep(120000)
	    ' Windows Eyes Tests
		wshell.Run "D:\ShareThis\EvernixScripts\EVXTestsAI2W0042.vbs "&line,4,False
	    WScript.Sleep (120000)	
	    wshell.Run "D:\ShareThis\EvernixScripts\EVXTestsAI2W0038.vbs "&line,4,False
	    WScript.Sleep (120000)				    	    
