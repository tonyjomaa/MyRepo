' ********************************************************************************
' Copyright (c) 2013, Algorithmic Implementations, Inc. (dba Ai Squared)
' All Rights Reserved.
'
' Developer:     Tony Jomaa
' 
' Description:   EVXTestsAI2WCYBER01.vbs queues up testes on said machine
'
...
'************* declarations  *********************************************************//
file="D:\ShareThis\EVXCommand11\AI2WCYBER01TestTable.txt"
machine = "AI2WCYBER01"	
