...
Else 
	...
	End If
End If 
If Not objFSO.FolderExists(buildpath & "\Reports\QA\Win1064") Then
	objFSO.CreateFolder (buildpath & "\Reports\QA\Win1064")
	WScript.Sleep(100)
End If
...
If WScript.Arguments.Count=0 Then
  buildpath = buildpath & "\Reports\QA\Win1064\Stability" &"_"& stryear &"-"& strmonth &"-"& strday &"_"& thetime
Else
  buildpath = buildpath & "\Reports\QA\Win1064\"&WScript.Arguments.Item(0)&"_"& stryear &"-"& strmonth &"-"& strday &"_"& thetime
End If
