...
Else 
	...
	End If
End If 
If Not objFSO.FolderExists(buildpath & "\Reports\QA\Win764") Then
	objFSO.CreateFolder (buildpath & "\Reports\QA\Win764")
	WScript.Sleep(100)
End If
...
If WScript.Arguments.Count=0 Then
  buildpath = buildpath & "\Reports\QA\Win764\Stability" &"_"& stryear &"-"& strmonth &"-"& strday &"_"& thetime
Else
  buildpath = buildpath & "\Reports\QA\Win764\"&WScript.Arguments.Item(0)&"_"& stryear &"-"& strmonth &"-"& strday &"_"& thetime
End If
