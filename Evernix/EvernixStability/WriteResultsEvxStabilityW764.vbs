...
resultfile = "\\ai2s-lab02\D\ShareThis\EVXResults\ResultsEvxStabilityWin764.txt"
'Result = "PASSED"

'Set f2 = objfso.GetFile("d:\Utils\grade.txt")
'Set f2 = f2.OpenAsTextStream(1, -1)
'	Result = f2.ReadLine	
...
'If Result = "PASSED" Then 
	'If status = 0 Then 
		'Result = "PASSED"
		Set objstream = objFSO.OpenTextFile (resultfile,2,False,0)
...
'action = "Program Echo In Settings UI BlackBox Test > Results reported"
'Stamp = Now
'LogToFileFunction BuildPath,Result,Stamp,action  
